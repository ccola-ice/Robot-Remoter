...
{
	printf("\r\n开始进行SD卡基本测试前，请插入32G以内的SD卡\r\n");			
    printf("\r\n本测试会对SD卡进行非文件系统方式读写，会删除SD卡的文件系统\r\n");		
    printf("\r\n后可通过电脑格式化或使用SD卡文件系统的例程恢复SD卡文件系统\r\n");		
    printf("\r\n但sd卡内的原文件不可恢复，测试前务必备份SD卡内的原文件！！！\r\n");		
    printf("\r\n开始进行SD卡读写测试\r\n");
...
{  
	...
	{
		printf("SD卡擦除测试失败！\r\n");
		printf("部分SD卡不支持擦除测试，若SD卡能通过下面的single读写测试，即表示SD卡能够正常使用。\r\n");
	}
}
